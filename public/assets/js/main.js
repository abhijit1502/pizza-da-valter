...
! function (e) {
    ...
    o = ".popup-search-box", i = ".searchClose", r = "show", e(".searchBoxToggler").on("click", (function (t) {
        ...
        function (t, a, s, n) {
            ...
            e(this).each((function () {
                ...
                s = Math.floor(l.height() / 2), n = l.attr(t), o = l.attr(a), i = m(e(o).css("padding-top")), r = m(e(o).css("padding-bottom")), "top-half" === n ? (e(o).css("padding-bottom", r + s + "px"), l.css("margin-top", "-" + s + "px")) : "bottom-half" === n && (e(o).css("padding-top", i + s + "px"), l.css("margin-bottom", "-" + s + "px"))
            }))
        };
    e("[data-sec-pos]").length && e("[data-sec-pos]").imagesLoaded((function () {
        ...
        e(this).each((function () {
            ...
            s = c.attr(t), n = c.attr(a), o = c.data("margin-top"), i = c.data("margin-bottom"), r = m(e(n).css("padding-top")), l = m(e(n).css("padding-bottom")), "margin-top" === s ? (e(n).css("padding-bottom", l + m(o) + "px"), c.css("margin-top", "-" + m(o) + "px").css({
                position: "relative",
                "z-index": "3"
            })) : "margin-bottom" === s && (e(n).css("padding-top", r + m(i) + "px"), c.css("margin-bottom", "-" + m(i) + "px").css({
                position: "relative",
                "z-index": "3"
            }))
        }))
